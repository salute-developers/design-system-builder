...
- Для реализации потребуется вынести бизнес-логику из `frontend-kt/cli` в общие Kotlin Multiplatform модули.
...
- Какие общие KMP-модули выделить первыми из текущего `frontend-kt/cli`: `core/application`, `core/network`,
