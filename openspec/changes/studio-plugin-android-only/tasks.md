...
- [ ] 2.2 Вручную: после выбора tenant сразу открывается список токенов; крошки заканчиваются tenant; одиночные проект/дизайн-система/tenant пропускаются; «Копировать код» работает
