# documentation-bundle-cli-publishing Specification

## Purpose
TBD - created by archiving change connect-cli-documentation-bundle-upload. Update Purpose after archive.
## Requirements
...
- **WHEN** выполняется сборка `frontend-kt/cli`
