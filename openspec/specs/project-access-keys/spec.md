# project-access-keys Specification

## Purpose
Определяет project-bound access keys для CLI и интеграций DS Builder, включая создание, хранение, отзыв и проверку ключей, а также trusted context для `project_key` actor.
