...
import com.dsbuilder.frontend.cli.feature.components.domain.ComponentPackageFile
...
class LocalComponentPackageDirectoryTest {
    ...
    fun readsEmptyStateWhenDirectoryIsAbsent() {
        val reader = LocalComponentPackageDirectoryReader(InMemoryCliFileSystem())
    ...
    fun readsEntriesAndFileNames() {
        val fileSystem = InMemoryCliFileSystem(
            initialFiles = mapOf(
