                ...
                NavigationNode(
                    ...
                    items = listOf(
                        NavigationNode(
                            ...
                            merge = com.dsbuilder.frontend.cli.feature.docs.domain.MergePolicy.Append,
                        ),
                    ),
                ),
            ),
        ...
        val user = Structure(
            ...
            navigation = listOf(
                NavigationNode(
                    title = "Page",
                    path = "user/page.md",
                    merge = com.dsbuilder.frontend.cli.feature.docs.domain.MergePolicy.Replace,
                ),
            ),
        )
        ...
        val user = Structure(
            ...
            navigation = listOf(
                NavigationNode(
                    title = "Page",
                    path = "user/page.md",
                    merge = com.dsbuilder.frontend.cli.feature.docs.domain.MergePolicy.Prepend,
                ),
            ),
        )
