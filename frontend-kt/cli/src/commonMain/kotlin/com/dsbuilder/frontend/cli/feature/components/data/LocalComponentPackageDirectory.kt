        ...
        val meta = if (fileSystem.exists(metaPath)) {
            try {
                json.decodeFromString(
                    com.dsbuilder.frontend.cli.feature.components.domain.ComponentPackageMeta.serializer(),
 ...
 */
private fun defaultDirectory(fileSystem: CliFileSystem, context: ProjectContext): String {
