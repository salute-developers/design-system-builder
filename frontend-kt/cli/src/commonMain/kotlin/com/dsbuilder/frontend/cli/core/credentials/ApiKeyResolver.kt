package com.dsbuilder.frontend.cli.core.credentials

import com.dsbuilder.frontend.cli.core.config.CredentialReference

internal const val DEFAULT_API_KEY_ENV = "DSBUILDER_API_KEY"
...
public class ApiKeyResolver(
    ...
    public fun resolve(
        ...
        val configuredEnvName = credentialReference?.name
