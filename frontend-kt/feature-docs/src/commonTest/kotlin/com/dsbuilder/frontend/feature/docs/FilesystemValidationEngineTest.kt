...
import com.dsbuilder.frontend.feature.docs.domain.ContentRef
...
import com.dsbuilder.frontend.feature.docs.domain.ResolvedNavigationNode
import com.dsbuilder.frontend.feature.docs.domain.Source
import com.dsbuilder.frontend.feature.docs.domain.validateDuplicatePaths
import com.dsbuilder.frontend.feature.docs.domain.validatePathSafety
...
class FilesystemValidationEngineTest {
    ...
    fun fileSystemValidationChecksContentExists() {
        withTempDirectory { tempRoot ->
            ...
            val fileSystem = TestWorkspaceFileSystem(docsDir)
            ...
            assertTrue(
                errors.any { it is com.dsbuilder.frontend.feature.docs.domain.ValidationError.MissingContent },
            )
        }
    }
    ...
    fun fileSystemValidationChecksManifestArtifacts() {
        withTempDirectory { tempRoot ->
            ...
            val docsDir = tempRoot.toString()
            val fileSystem = TestWorkspaceFileSystem(tempRoot.toString())
            val engine: DocsValidationEngine = FilesystemValidationEngine(fileSystem)
            ...
            assertTrue(
                errors.any { it is com.dsbuilder.frontend.feature.docs.domain.ValidationError.MissingArtifact },
            )
        }
    }
