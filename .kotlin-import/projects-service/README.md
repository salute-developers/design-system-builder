...
Для production используется корневой [docker-compose.prod.yml](/Users/alex/IdeaProjects/design-system-builder-kt/docker-compose.prod.yml) и безопасный шаблон переменных [`.env.prod.example`](/Users/alex/IdeaProjects/design-system-builder-kt/.env.prod.example).
