---
name: sync-routes
description: Sync js/services/db-service/src/routes/api/ and routes/index.ts with the current DB schema. Use when tables are added or removed in js/services/db-service/src/db/schema.ts.
---
...
2. Read `js/services/db-service/src/routes/api/` — list existing route files.
3. Read `js/services/db-service/src/validation/schema.ts` — check which Create/Update schemas exist.
4. Read `js/services/db-service/src/routes/index.ts` — check which routers are already imported and registered.
...
**1. Create `js/services/db-service/src/routes/api/my-table.ts`**
...
**2. Register in `js/services/db-service/src/routes/index.ts`**
