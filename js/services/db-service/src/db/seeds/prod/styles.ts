...
export async function seedStyles(
    ...
    const declared: { designSystemId: string; variationId: string; name: string; description: string; isDefault: boolean }[] = [
            ...
            {
                designSystemId: base.id,
                variationId: v.textFieldView.id,
                name: 'default',
                description: 'default',
                isDefault: true,
            },
            ...
            {
                designSystemId: base.id,
                variationId: v.textFieldSize.id,
                name: 'xl',
                description: 'xl',
                isDefault: false,
            },
            ...
            {
                designSystemId: base.id,
                variationId: v.textFieldLabelPlacement.id,
                name: 'inner',
                description: 'inner',
                isDefault: false,
            },
            ...
            {
                designSystemId: base.id,
                variationId: v.textFieldChipView.id,
                name: 'default',
                description: 'default',
                isDefault: false,
            },
            ...
            {
                designSystemId: base.id,
                variationId: v.textFieldHintView.id,
                name: 'default',
                description: 'default',
                isDefault: false,
            },
            {
                designSystemId: base.id,
                variationId: v.textFieldHintSize.id,
                name: 'm',
                description: 'm',
                isDefault: false,
            },
    ...
    const s = {
        ...
        // TextField
        base_tex_view_default: find(v.textFieldView.id, 'default'),
        base_tex_view_positive: find(v.textFieldView.id, 'positive'),
        base_tex_view_warning: find(v.textFieldView.id, 'warning'),
        base_tex_view_negative: find(v.textFieldView.id, 'negative'),
        base_tex_size_xl: find(v.textFieldSize.id, 'xl'),
        base_tex_size_l: find(v.textFieldSize.id, 'l'),
        base_tex_size_m: find(v.textFieldSize.id, 'm'),
        base_tex_size_s: find(v.textFieldSize.id, 's'),
        base_tex_size_xs: find(v.textFieldSize.id, 'xs'),
        base_tex_labelPlacement_inner: find(v.textFieldLabelPlacement.id, 'inner'),
        base_tex_labelPlacement_outer: find(v.textFieldLabelPlacement.id, 'outer'),
        base_tex_chipView_default: find(v.textFieldChipView.id, 'default'),
        base_tex_chipView_secondary: find(v.textFieldChipView.id, 'secondary'),
        base_tex_chipView_accent: find(v.textFieldChipView.id, 'accent'),
        base_tex_chipView_positive: find(v.textFieldChipView.id, 'positive'),
        base_tex_chipView_warning: find(v.textFieldChipView.id, 'warning'),
        base_tex_chipView_negative: find(v.textFieldChipView.id, 'negative'),
        base_tex_hintView_default: find(v.textFieldHintView.id, 'default'),
        base_tex_hintSize_m: find(v.textFieldHintSize.id, 'm'),
        base_tex_hintSize_s: find(v.textFieldHintSize.id, 's'),
    };
