import type { TokenType, Variations } from './token';
...
const spacingTuple = ['kind', 'size'] as const;
export type SpacingMetaTuple = typeof spacingTuple;
export type SpacingMeta = Record<SpacingMetaTuple[number], Array<string>>;
